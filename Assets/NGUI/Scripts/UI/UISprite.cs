...
public class UISprite : UIWidget
{
	...
	public override void OnFill (BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
	{
		...
		if (tex != null)
		{
			...
			if( atlas.IsResize() ){
				mOuterUV = NGUIMath.ConvertToTexCoords(mOuterUV, atlas.AtlasWidth, atlas.AtlasHeight );
				mInnerUV = NGUIMath.ConvertToTexCoords(mInnerUV, atlas.AtlasWidth, atlas.AtlasHeight );
			}
			else{
